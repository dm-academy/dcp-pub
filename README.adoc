...
Finally, while Agile techniques are certainly mentioned, they are typically grafted on to a narrative that remains very functional. Mostly, Agile may be discussed in the context of project management, but overall questions of end to end flow, product management, Agile infrastructure, culture and organization, and many other such topics go unaddressed. This is a problem, as we are starting to see shakeups in the talent market due to larger enterprises adopting Agile. I am aware of hundreds of experienced IT professionals being laid off in my region, due at least in part to Agile transformations.
