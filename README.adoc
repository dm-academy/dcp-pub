...
For example, in the ITIL framework, one learns that "an Incident is different from a Problem." From the perspective of a student new to IT, that is a meaningless semantic distinction that will certainly not be retained after the class, if they even manage to remember it for the final.
