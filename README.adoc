...
This Readme is written primarily for potential collaborators and *customers* (in the sense of selecting for a course) of the book:footnote:[Of course, if you are a student to whom this book has been assigned, feel free to read this if you're curious about the origins of this work.]
