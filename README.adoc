...
There are two main views on the book:

* The http://dm-academy.github.io/aitm/[student edition]

* The http://dm-academy.github.io/aitm/aitm-instructor.html[instructor's edition], with additional commentary and background

Both are generated from the same source files. Include macros are used to include the additional instructor commentary. 
