...
.... *Maturation*: Students are in groups of 4-5, representing the executive leadership of a large enterprise, concerned with IT portfolios, analytics, and the complex dynamcis of running IT at massive scale.

Elaborating the above outline, we have:
...
..... *Coordination*
[start=7]
. _Culture and organization_
. _Process management_
. _Project and resource management_

..... *Maturation*
[start=10]
. _Architecture and governance_
. _Portfolio and analytics_
. _Chaos and complexity_
