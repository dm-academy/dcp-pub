...
The challenges of this legacy are an ongoing theme throughout this introductory text.
...
The successes of Agile are notable. Evidence for Agile software develop methods, and a related set of approaches that have coalesced into what we might call the digital ecosystem, continues to accumulate.
