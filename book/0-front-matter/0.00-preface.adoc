...
Evidence for Agile software develop methods, and a related set of approaches that have coalesced into what we might call the digital ecosystem, continues to accumulate.
