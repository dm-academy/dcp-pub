...
==== Evidence for Agile
A rigorous comparison of 26 agile projects against a baseline database of
7,500 primarily traditional development projects.This study was con
ducted by Michael Mali, managing partner of QSM Associates (QSMA),
which has been collecting productivity, quality, and other metrics on
projects for more than 15 years.The agile projects Mah studied ranged
in size from 60 to 1,000 people (Mah 2008). (cited in <<Cohn2010>>)
...
.... *Inception*: The students are teamed as 2-3 practitioners , each in a hypothetical startup, in a garage.
