...
..... *Team of Teams*
[start=7]
. _Organization and culture_ We're getting big. How do we deal with this? How are we structured? Why this way and not that? What are the unwritten values and rules in our company?
