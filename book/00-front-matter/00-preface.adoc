...
I propose this book as an initial “OO” of the “OODA” loop for those seeking Agile transformation of their IT capabilities. Its purpose is to provide you a well documented set of observations on its current state and challenges that can orient you. My hope is that these observations will guide you to more effective decisions and actions in your journey toward IT excellence.
