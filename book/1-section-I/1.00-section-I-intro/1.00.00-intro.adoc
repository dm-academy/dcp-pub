...
In this section, we  explore the fundamentals of information technology delivery, in terms of the practical concerns required to actually launch a viable digital product.
