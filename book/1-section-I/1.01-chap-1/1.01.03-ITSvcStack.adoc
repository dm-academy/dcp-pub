...
Therefore, as we study this world, we need to mantain awareness of her perspective. She is seeking some value that IT uniquely can enable, but does not want to consider all the complexity that goes into it.
