==== Defining user, customer, and sponsor
...
* The *user* is the person actually interacting with the IT-based service
* The *customer* is source of revenue for the service. If the service is part of a profit center, the customer is the person actually purchasing product (e.g. demand deposit banking.) If the service is part of a cost center (e.g. an HR system), the customer is best seen as an internal executive, as the actual revenue-producing customers are too far removed.
...
|====
|Example |User |Customer |Sponsor |Notes
