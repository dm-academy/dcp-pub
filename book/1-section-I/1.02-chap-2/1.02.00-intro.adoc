...
This is one of the more technical chapters. Supplementary reading may be required for those completely unfamiliar with computing. See http://dm-academy.github.io/aitm/aitm-collaborator.html#_assumptions_of_the_reader[Assumptions of the Reader] for notes on the book's approach.
