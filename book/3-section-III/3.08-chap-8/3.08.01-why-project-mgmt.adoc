...
The project has an explicit concept of dependencies in the tasks, and powerful tools to manage them. While this book aligns with the Agile movement in avoiding unwise or uncalled for use of dependencies, they *do* exist - especially in the most ambitious and complex product efforts! And techniques are needed to manage them.
