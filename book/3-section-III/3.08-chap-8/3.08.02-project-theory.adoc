...
Finally, while this book does not go into architectural styles in depth, there is some evidence that a well-considered microservices approach can help minimize the dependency management that larger, more "monolithic" systems are prone to.
****
 need citations
