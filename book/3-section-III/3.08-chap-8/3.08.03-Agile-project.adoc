...
We have seen earlier versions of this problem in our discussion of work management. However, simple Kanban and visual Andon is no longer sufficient, given the nature of the coordination we now require. We need a more diverse and comprehensive set of techniques.
...
* Co-location (The Big Room) - this should go into ch 7?
** Significant organizational advantages
** Setup/teardown of connections fast & lightweight
*** Nautical signal flags (Cohn)
** Shared mental model (commander's intent) easiest to communicate
...
A wealth of additional techniques is to be found in <<Larman2009>>.
