...
IT has long been viewed as a "business within a business." The increasing sourcing options including various Cloud options make it more and important that internal digital services be comparable to external markets.

In the internal market model, services 

This in turn puts constraints on traditional IT cost recovery approaches, which often result in charges with no seeming relationship to reasonable market prices.
...
Combining Meyer's and Huntzinger's thinking, for example, excess capacity waste would be owned at the top of the house (either as a Subsidy or a Venture), and not rolled into value stream cost accounting.
...
====== Service brokerage
Finally, there is the idea that digital or IT services should be aggregated and "brokered" by some party (perhaps the descendant of a traditional IT organization).

lso helps with excess capacity problem - brokered services can be direct VS charges
