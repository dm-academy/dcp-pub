...
A *notation* is a specific set of visual symbols mapped onto a modeling language. One modeling language might have different notations.
...
A useful framework for thinking about activities represented as icons is the IGOE approach. IGOE stands for:
