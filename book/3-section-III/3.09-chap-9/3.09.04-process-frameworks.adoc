...
The CMMI has evolved since Humphrey's initial vision, but between its  unrealistic emphasis on statistical process control, and the idea that that process optimization is only relevant at the highest maturity, it is (in the view of this author) badly out of step with the reality of the new digital economy.
