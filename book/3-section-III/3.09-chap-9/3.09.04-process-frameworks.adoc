...
We have discussed the problems of process control with respect to the CMM in particular. There are a variety of other concerns with respect to the process frameworks:
...
Large batch orientation with complex spiderweb of interations surrounding each major phase
