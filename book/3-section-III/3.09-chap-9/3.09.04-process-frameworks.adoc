...
The other frameworks do not embrace statistical process control to the same extent as the CMMI. PMBOK suggests that control charts "control charts may also be used to monitor cost and schedule variances, volume, and frequency of scope changes, or other management results to help determine if the project management processes are in control." This also contradicts the insights of empirical process control, unless the project were also a fully defined process (unlikely). (<<PMI2013>>, Kindle Locations 4108-4109).
...
Good system design is a complex process, and we will discuss technical debt in Chapter 12. But the slow feedback signals that result from the artifact-centric batch processes implied by some frameworks are unacceptable in current industry, which is why new approaches are being adopted.
